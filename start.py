...
def drawText(text,color,font,size,x,y):
    ...
    textSurfaceObj = fontobj.render(text, True, color, (0,0,0))
...
def showStartScreen():
    ...
    while not done:
        ...
        surfaceobj,rectobj = drawText('INTERSTELLAR',white,'Agency FB',48,WINSIZE[0]/2-10,WINSIZE[1]/2-10)
        screen.blit(surfaceobj,rectobj)
        surfaceobj,rectobj = drawText('ArrowKeys - To Move',white,'Agency FB',24,WINSIZE[0]/2,WINSIZE[1]/2+40)
        screen.blit(surfaceobj,rectobj)
        surfaceobj,rectobj = drawText('SpaceBar - To Shoot',white,'Agency FB',24,WINSIZE[0]/2,WINSIZE[1]/2+70)
        screen.blit(surfaceobj,rectobj)
